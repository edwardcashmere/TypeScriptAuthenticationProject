...
const payload = {
    body: (0, zod_1.object)({
        ...
        description: (0, zod_1.string)({ required_error: " Title is required" }).min(120, "Description must be more than 120 characters"),
        price: (0, zod_1.number)({ required_error: "Price is required" })
    })
};
const params = {
    params: (0, zod_1.object)({
        productId: (0, zod_1.string)({ required_error: "productId is required" })
    })
};
